...
import com.example.mycomic.net.download.HttpDownManager;
    ...
    public void initData() {
        ...
        for(Map.Entry<Integer,Integer> mapping:list){
            ...
            if(mapping.getValue() != Constants.CHAPTER_FREE){
                item = new DownInfo();
                item.setUrl("http://sw.bos.baidu.com/sw-search-sp/software/f84db5c1e9853/QQPhoneManager_5.8.1.5162.exe");
