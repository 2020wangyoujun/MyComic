...
import com.example.mycomic.data.entity.FullHomeItem;
import com.example.mycomic.data.entity.LargeHomeItem;
import com.example.mycomic.data.entity.SmallHomeItem;
...
//
    ...
    public static Comic TransToComicDetail(Document doc){
        ...
        try{
            ...
            comic.setPopularity(ElementPopularity.select("em").get(2).text());
