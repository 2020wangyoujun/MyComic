package com.example.mycomic.data.commons;
...
public class Url {
    ...
    //更换为app抓包的域名
    public static String TencentComicChapters2 = "https://a.ac.qq.com/";
    ...
    public static String KukuComicImageBae ="http://n9.1whour.com/";
